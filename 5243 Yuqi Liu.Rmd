...
library(SnowballC)
library(dplyr)
data<- read.csv("Downloads/cleaned_hm.csv")
food_dict <- read_csv("Downloads/food-dict.csv")
entertainment_dict <- read_csv("Downloads/entertainment-dict.csv")
exercise_dict <- read_csv("Downloads/exercise-dict.csv")
people_dict <- read_csv("Downloads/people-dict.csv")
pets_dict <- read_csv("Downloads/pets-dict.csv")
shopping_dict <- read_csv("Downloads/shopping-dict.csv")
work_dict <- read_csv("Downloads/work-dict.csv")
family_dict <- read_csv("Downloads/family-dict.csv")
school_dict <- read_csv("Downloads/school-dict.csv")
demographic <- read_csv("Downloads/demographic.csv")
...
We can find that in India，food and family are usually closely linked. Whereas in America, a happy moment for people can be having a cup of coffee alone
